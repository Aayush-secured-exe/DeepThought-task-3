  ...
  return (
    <div className="max-w-sm rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <h3 className="text-base font-semibold text-gray-900">{membership[0].type}</h3>
      </div>
      ...
      <div className="mt-5 rounded-lg border border-gray-200 p-4">
        ...
        <p className="mt-1 text-sm font-medium text-gray-700">{membership[0].type}</p>
      </div>
      ...
      <div className="mt-5 border-t border-b border-gray-100 py-4">
        ...
        <p className="mt-1 pl-2 text-sm text-gray-700">{membership[0].status}</p>
      </div>

      <div className="mt-4 flex items-center justify-between">
        <p className="text-xs text-gray-500">ID: {membership[0].id}</p>
